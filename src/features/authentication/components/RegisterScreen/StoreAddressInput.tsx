...
export const StoreAddressInput: React.FC<StoreAddressInputProps> = ({
  value,
  onChangeText,
  placeholder,
}) => {
  const { t } = useTranslation();
  const defaultPlaceholder = placeholder || t('signup:storeAddressInput.placeholder');

  return (
    <View style={styles.container}>
      <View style={styles.inputContainer}>
        <HugeiconsIcon icon={Location01Icon} size={20} color={colors.text.secondary} />
        <TextInput
          style={styles.input}
          value={value}
