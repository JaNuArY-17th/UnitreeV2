...
export const StoreNameInput: React.FC<StoreNameInputProps> = ({
  value,
  onChangeText,
  placeholder,
}) => {
  const { t } = useTranslation();
  const defaultPlaceholder = placeholder || t('signup:storeNameInput.placeholder');

  return (
    <View style={styles.container}>
      <View style={styles.inputContainer}>
        <HugeiconsIcon icon={Store01Icon} size={20} color={colors.text.secondary} />
        <TextInput
          style={styles.input}
          value={value}
